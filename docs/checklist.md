...
- [ ] **Cập nhật thông tin cấu hình vào Tab "Cài đặt" trên giao diện**
...
- [ ] **Sao lưu cơ sở dữ liệu**
  - Dữ liệu leads và lịch sử crawl nằm trong PostgreSQL (bảng `leads`, `crawl_logs`). Hãy thiết lập backup định kỳ (`pg_dump` hoặc tính năng backup tự động của nhà cung cấp DB).
